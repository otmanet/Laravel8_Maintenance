    ...
    <div style="width:220px;height: 100%;" id="app">
        ...
        <ul class="navbar-vertical">
            ...
            <li><a href="/Admin/Departement">
                ...
                <li><a href="/Admin/Form/Ajouter/Departement">
                        <p>Ajouter Department</p>
                    </a></li>
                    <li><a href="/Admin/Machine">
                            <p>Machine</p>
                        </a></li>
                      <li><a href="/Admin/Machine/Ajouter">
                            <p>Ajouter Machine</p>
                        </a></li>
            <li><a href="/Admin/maintancesValide">
                    <p>Maintenance Valider</p>
                </a></li>
            <li><a href="/Admin/maintancesNonValide">
                    <p>Maintenance Non Valider</p>
                </a></li>
