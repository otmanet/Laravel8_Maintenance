...
<h3>Ajouter Nouvelle Maintenance</h3><br>

<div>
    <form action="/Ajouter/Maintance" method="post" >
        @csrf
        <label for="fname">Nom Maintenance</label>
        <input type="text" id="fname" name="name_maintance" placeholder="Nom Maintenance.."><br><br>

        <label for="lname">Date Debut</label>
        <input type="date" id="lname" name="dateDebut" style="margin-right: 60px">
        <label for="lname">Date Fin</label>
        <input type="date" id="lname" name="dateFin" ><br><br>
        <label for="lname">Type Maintenance</label>
        <input type="text" id="lname" name="TypeMaintence">
        ...
        <textarea name="material" id="" cols="50" rows="10" style="width:100%"></textarea>
